      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md glass rounded-2xl p-8 border border-white/20"
          >
            <button
              onClick={onClose}
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 text-white/70">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full mt-4 flex items-center justify-center px-4 py-3 border border-white/20 rounded-lg bg-white/10 hover:bg-white/20 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {isLogin && (
              <div className="mt-4 text-center">
                <button className="text-white/70 hover:text-white/90 text-sm transition-colors duration-200">
